...
$result=mysqli_query($link, $insert);
		...
		if($result){
			...
			echo "<script>alert('Post Successfully!');window.location.href='../lostPet-main.php';</script>";
		}else {
			echo "<script>alert('Post Failed!');window.location.href='../lostPetSubmit.php' </script>";
		}
