...
<body>
	...
	<div class="content">
		...
		<form method="post" action="php/pwChange.handle.php">
		<input type="hidden" name="uid" value="<?php echo $uid;?>">
		<div class="cont-inner">
			<ul>
				<li>Old Password: <input type="password" name="opassword" id="username" /></li>	
				<li>New Password: <input type="password" name="password" required="true" id="password" /></li>
				<li>Confirm New Password: <input type="password" name="passwordtoo" required="true" id="passwordtoo" onchange="check()"><span id="tishi"></span></li>
			</ul>
			<div class="cont-btn">
